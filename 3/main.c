...
int main(void)
{
    ...
    int *A_matrix = malloc(sizeof(int) * sparce_matrix.size);
    int *JA_matrix = malloc(sizeof(int) * sparce_matrix.size);
    int *JA_vector = malloc(sizeof(int) * sparce_vector.size);
    int *JA_result = malloc(sizeof(int) * sparce_matrix.xsize);
    int *A_vector = malloc(sizeof(int) * sparce_vector.size);
    ...
    print_compare_results(std_matrix, sparce_matrix, std_start, std_end, sparce_end, size);
